...
export const defaultOptions = {
  ...
  sectionsTitlesClasses: ['text-h4', 'text-subtitle-1', 'text-subtitle-2'],
  arrayItemsTitlesClasses: ['text-h4', 'text-subtitle-1', 'text-subtitle-2'],
  childrenClass: '',
  fieldProps: { density: 'compact' },
  fieldColProps: { cols: 12 },
  readOnlyFieldProps: { hideDetails: true },
  textFieldProps: { density: 'compact' },
  textareaProps: { filled: true, density: 'compact' },
  numberProps: { },
  sliderProps: { },
  checkboxProps: { },
  switchProps: { },
  comboboxProps: { density: 'compact', style: 'z-index: 9999;' },
  selectProps: { density: 'compact', style: 'z-index: 9999;' },
  fileInputProps: { density: 'compact' },
  radioGroupProps: { },
  radioItemProps: { },
  tabsProps: { grow: true },
  expansionPanelsProps: { mandatory: 'force' },
  ...
  tooltipProps: { location: 'start', openOnHover: false, openOnClick: true, style: 'z-index: 9999;' },
