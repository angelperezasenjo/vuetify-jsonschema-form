  ...
  methods: {
    ...
    renderSelectionControlItem(item) {
      ...
      const props = {
        ...
        label,
        value,
        modelValue: this.separator && typeof this.modelValue.value === 'string' ? this.modelValue.value.split(this.separator) : this.modelValue.value,
    ...
    renderSelectProp() {
      ...
      const children = { default: () => this.renderPropSlots() }
