    ...
    input(value, initial = false, fastForward = true) {
      ...
      if (value === null || value === undefined) {
        if (this.fullSchema.nullable) {
          ...
          if (this.modelValue !== null) {
            this.changed = true
            if (fastForward) this.fastForwardEvent('update:modelValue', { key: this.fullKey, value: undefined })
        ...
        if (!deepEqual(value, this.modelValue)) {
          ...
          if (fastForward) this.fastForwardEvent('update:modelValue', { key: this.fullKey, value: value })
