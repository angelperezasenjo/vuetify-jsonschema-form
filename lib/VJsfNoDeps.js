...
export default {
  ...
  render() {
    ...
    return h(resolveComponent('v-col'), { cols: colProps.cols, class: this.propertyClass, style: 'z-index: 9999', menuProps: { style: 'z-index:9999;', persistent: true } }, { default: () => children })
  }
}
